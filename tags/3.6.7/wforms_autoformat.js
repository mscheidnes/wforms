...
wFORMS.behaviors.autoformat = {
    ...
    applyTo: function(f) {
        ...
        elements.forEach(function(element){
            ...
            infoEntry.promptLayer = wFORMS.behaviors.autoformat._makeAutoformatControlUI(element);
        });
    ...
    _makeAutoformatControlUI : function(element){
        ...
        newDiv.className = 'autoformat-background';
        var elementComputedStyle = base2.DOM.AbstractView.getComputedStyle(window, element, '');
        var backgroundProperties = ['background', 'background-attachment', 'background-clip', 'background-color', 'background-image',
        ...
        var properties = ['padding-left', 'padding-right', 'font-size'];
        ...
        newDiv.style.fontFamily = elementComputedStyle.getPropertyValue('font-family');
    ...
    _mirrorWrapperDiv : function(element){
        ...
        positioningDiv.style.display = elementComputedStyle.getPropertyValue('display');
        positioningDiv.appendChild(element);
        positioningDiv.className = 'autoformatprompt-hook';

        //transfer the border attributes to wrapping layer (the order of the attributes matter)
        var transferredAttributes = ['border', 'border-color', 'border-style', 'border-width',
