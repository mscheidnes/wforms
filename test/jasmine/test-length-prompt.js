...
(function(){
    ...
    describe("A wForms length prompt behaviour", function(){
        ...
        it("should be able to create cache entries for the following input types: text, email, url", function(){
            var idForTextField = $('input[type="text"]').attr('id');
            console.log(idForTextField);
            console.log(wFORMS.behaviors.lengthPrompt._globalCache);
//            expect(idForTextField in wFORMS.behaviors.lengthPrompt._globalCache).toBeTruthy();
        });
    ...
    xdescribe("Controller inheritance", function() {
    ...
    xdescribe("A Controller", function(){
    ...
    xdescribe("A Secure Method", function(){
        var deferred = new $.Deferred();
        var testValue = 0;
    ...
    xdescribe("A BackboneMVC model", function(){
